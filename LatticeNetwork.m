...
% generates a graph G that encodes a square network
% dimension - the number if nodes is dimenstion squared
% designe - 4 or 8, the maximum connectivity of the graph
